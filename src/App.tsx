...
function App() {
  const [selectedSchema, setSelectedSchema] = useState<SchemaType>('Organization');
      ...
      <div className='container mx-auto py-8 px-4'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-8'>
            ...
            <p className='text-muted-foreground'>Generate JSON-LD structured data for your website</p>
          </div>
          ...
          <Card className='mb-6'>
            <CardContent className='pt-6'>
              <div className='space-y-2'>
                ...
                <SchemaTypeSelector id='schema-select' value={selectedSchema} onValueChange={setSelectedSchema} />
              </div>
            </CardContent>
          </Card>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            {/* Form Section */}
            <div>
              <SchemaForm key={selectedSchema} schemaType={selectedSchema} onDataChange={setJsonldData} />
            </div>
