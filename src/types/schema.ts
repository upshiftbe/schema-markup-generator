...
export const SCHEMA_TYPES: SchemaTypeInfo[] = [
  {
    label: "Organization",
    description: "Business, corporation, or organization",
    type: "Organization",
  },
  {
    label: "Article",
  ...
  },
  {
    ...
    description: "Local business listings (restaurants, shops, services)",
    type: "LocalBusiness",
  },
  {
    label: "Event",
    description: "Events, conferences, concerts",
    type: "Event",
  },
  {
    label: "FAQ Page",
  ...
  {
    label: "Job Posting",
    description: "Job listings and career pages",
    type: "JobPosting",
  },
  {
    label: "Person",
    description: "Personal profiles, authors, team members",
    type: "Person",
  },
  {
    label: "Video Object",
